...
class App extends React.Component{
	...
	render() {
        ...
        keyExtractor={(item, index) => index.toString()}
					ListFooterComponent={() => {
						return (<Text>-- Endaaaa --</Text>)
					}}
					onEndReachedThreshold={0}
					onEndReached={this.getCharacters.bind(this,this.state.currentPage + 1 ),this.getEpisodes.bind(this,this.state.currentPage + 1 )}
				/>
			</View>
		);
